<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BlogInstaller.ascx.cs" Inherits="Umlaut.Umb.Blog.usercontrols.BlogInstaller" %>
...
<umb:PropertyPanel runat="server">
    <p>
        <strong>Blog 4 Umbraco has been installed</strong>
    </p>
    <ul>
